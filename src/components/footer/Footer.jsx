...
export const Footer = () => {
  ...
  return (
    <footer className='lg:w-full bg-black  sticky right-0 bottom-20 lg:bottom-0 lg:m-0'>
      <div className='grid grid-cols-6 items-center mx-auto'>
        <article className='flex p-4 gap-4'>
          <CardSong />
        </article>
        <main className='flex flex-col gap-3 p-3 col-start-2 col-end-6'>
        ...
        <article className='flex items-center gap-3 justify-center'>
